...
const CGPAPage = () => {
  return (
    <div className="min-h-screen bg-background relative overflow-hidden circuit-board engineering-grid">
      ...
      <div className="absolute inset-0 bg-gradient-neural opacity-[0.02]" />
      <div className="absolute top-20 left-20 w-96 h-96 bg-gradient-hologram opacity-15 rounded-full blur-3xl animate-pulse-glow" />
      <div className="absolute bottom-20 right-20 w-80 h-80 bg-gradient-cyber opacity-10 rounded-full blur-3xl animate-pulse-glow delay-1000" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-neural opacity-5 rounded-full blur-3xl animate-spin-slow" />
